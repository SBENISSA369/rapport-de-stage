...
\section{chiffrement partiellement homomorphe}
...
%\textit{RSA : }
\subsection{RSA :}\textit{Je modifie ce paragraphe}
...
\section{chiffrement complètement homomorphe}
...
\subsection{Généralités sur les réseaux euclidiens}
...
\end{tabular}
\end{center}
\caption{Différent paramètres utilisées dans le schéma de FV}
\end{figure}
\newline
...
\section{Quelques Applications de chiffrement homomorphe a l'apprentissage automatique}
...
\subsection{Algorithme de descente du gradient stochastique \textit{(stochastic gradient descent)}}.\newline
...
\hspace*{1cm}\}\newline
\} 
\section{SEAL:Simple Encrypted Arithmetic Library}
\subsection{présentation de la bibliotheque}
